...
function showGrids() {
	...
	Coordinates.drawAxes({axisLength:7,axisOrientation:"x",axisRadius:0.02});//length x
	Coordinates.drawAxes({axisLength:7,axisOrientation:"y",axisRadius:0.02});//length y
}
function addToDOM() {
